...
const WHALE = new THREE.MeshStandardMaterial({ color: '#2e3238', roughness: 0.55, flatShading: true });
const PALE  = new THREE.MeshStandardMaterial({ color: '#8d8f8c', roughness: 0.7, flatShading: true });
